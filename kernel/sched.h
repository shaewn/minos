...
void sched_block_task_local(struct task *task, struct list_head *wait_head, spinlock_t * _Nullable lock);
...
void sched_block_task_remote(struct task *task, struct list_head *wait_head, spinlock_t * _Nullable lock);
